...
STATIC_ROOT = os.path.join(BASE_DIR, 'pizza-fe', 'build', 'static')
STATICFILES_DIRS = []
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'n44ju0$^^b5swfji+1+vq1(ym-505h36a=etvo^y8*h@p!44g3')
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'pizza-fe', 'build')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
